document.querySelector('#app').innerHTML = `
  <div class="relative">
    ...
    <div style="background-image: url('/abogacia.jpg');" class="h-screen md:h-screen md:bg-cover">
      <div class="absolute inset-x-0 mt-32 flex justify-center items-center">
        <div class="max-w-md mx-auto mt-16 md:ml-72 rounded-lg z-20">
          ...
          <p class="md:text-xl mx-4 text-green-900 font-semibold">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi magni similique doloribus quidem in perferendis fugiat, exercitationem eveniet veritatis numquam? Quos, dolores. In repudiandae soluta quas pariatur expedita magni ad!</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-red-800 w-full flex justify-center items-center">
      <p class="text-xl text-gray-600">Nombre 2024 | Todos los derechos reservados</p>
    </div>
  </div>
`;
